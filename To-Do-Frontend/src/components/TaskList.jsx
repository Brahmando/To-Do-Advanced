...
const TaskList = ({ tasks, handleComplete, handleDelete, formatDate }) => (
  <div>
    <h2 className="text-2xl font-semibold text-primary mb-4">Active Tasks ({tasks.length})</h2>
    {tasks.length === 0 && <div className="text-gray-400 text-center mb-4">No active tasks</div>}
    <div className="max-h-60 overflow-y-auto overflow-x-hidden"> {/* Hide horizontal scrollbar */}
