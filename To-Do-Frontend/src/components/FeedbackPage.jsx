...
const FeedbackPage = ({ user }) => {
  ...
  const handleSubmitFeedback = async () => {
    ...
    try {
      const response = await fetch('https://to-do-advanced-production.up.railway.app/api/feedback/submit', {
        method: 'POST',
        headers: {
  ...
  const handleSubmitSurvey = async () => {
    ...
    try {
      const response = await fetch('https://to-do-advanced-production.up.railway.app/api/feedback/submit-survey', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${localStorage.getItem('token')}`
