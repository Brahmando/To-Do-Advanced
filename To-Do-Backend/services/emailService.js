        ...
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #ddd; border-radius: 10px;">
          ...
          <div style="padding: 30px; background: #f9f9f9;">
            ...
            <div style="text-align: center; margin-top: 30px;">
              <a href="${process.env.FRONTEND_URL || 'https://to-do-advanced-rose.vercel.app'}" style="display: inline-block; background: #667eea; color: white; padding: 12px 25px; text-decoration: none; border-radius: 5px; font-weight: bold;">
          ...
          <div style="padding: 30px; background: #f9f9f9;">
            ...
            <div style="margin-top: 30px; padding: 15px; background: #fff3cd; border: 1px solid #ffeaa7; border-radius: 5px;">
              <p style="margin: 0; color: #856404; font-size: 14px;">
                ...
                <a href="${process.env.FRONTEND_URL || 'https://to-do-advanced-rose.vercel.app'}/about" style="color: #856404; text-decoration: underline;">About page</a> 
                to learn more about what we're building!
              </p>
            </div>
            
            <div style="text-align: center; margin-top: 30px;">
              <a href="${process.env.FRONTEND_URL || 'https://to-do-advanced-rose.vercel.app'}" style="display: inline-block; background: #28a745; color: white; padding: 12px 25px; text-decoration: none; border-radius: 5px; font-weight: bold;">
                🚀 Back to To-Do App
              </a>
            </div>
          </div>
